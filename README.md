...
Minimalistic [Vim](http://www.vim.org/) configurations. Highly based on the [vim-files](https://github.com/jvortmann/vim-files) by [@jvormann](https://github.com/jvortmann) (one of the greatest Vimmers of my generation) but much more simplified and opinionated based on my personal preferences.
